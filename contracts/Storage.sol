 ...
 * @notice A simple smart contract to store and retrieve a number on the blockchain.
 */
...
contract SimpleStoragePracticeContract {
     ...
     * @param _numberToStore The number to be stored
     */
    function handleStore(uint256 _numberToStore) public {
        number = _numberToStore;
    }
     ...
     */
    function handleRetrieve() public view returns (uint256) {
        return number;
    }
}
